    ...
    <section class="workbench" aria-label="请求与响应工作区">
      ...
      <div class="response-card" :aria-busy="running">
        ...
        <div v-if="running" class="loading-state" role="status" aria-live="polite">
          ...
          <div class="loading-lines"><i /><i /><i /></div>
        </div>
...
.capability-label { color: var(--accent); font-size: 10px; font-weight: var(--fw-bold); letter-spacing: .1em; text-transform: uppercase; }
...
.method { flex: 0 0 auto; padding: 4px var(--sp-2); border-radius: 5px; color: #fff; font-family: var(--mono); font-size: 10px; font-weight: var(--fw-bold); }
...
.example-card small { margin-top: 2px; color: var(--text-faint); font-size: 9px; }
...
.request-shortcut { display: inline-flex; align-items: center; gap: var(--sp-1); color: var(--text-faint); font-family: var(--mono); font-size: 9px; }
...
.path-field label span { color: var(--text-faint); font-size: 9px; font-weight: var(--fw-medium); }
...
.no-body strong { font-size: var(--fs-sm); }.no-body small { margin-top: 2px; color: var(--text-faint); font-size: 10px; }
.run { width: calc(100% - var(--sp-8)); display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: var(--sp-2); min-height: 48px; margin: var(--sp-4); padding: 0 var(--sp-4); border: 0; border-radius: var(--radius-sm); background: linear-gradient(100deg, var(--accent), var(--accent-2)); color: #fff; box-shadow: 0 8px 18px color-mix(in srgb, var(--accent) 22%, transparent); cursor: pointer; font: inherit; font-size: var(--fs-sm); font-weight: var(--fw-semibold); }
...
.status { display: inline-flex; align-items: center; gap: var(--sp-2); font-family: var(--mono); font-size: 10px; font-weight: var(--fw-semibold); }
...
.elapsed { display: inline-flex; align-items: center; gap: var(--sp-1); color: var(--text-faint); font-family: var(--mono); font-size: 9px; }
...
.next-experiment span, .next-experiment strong { display: block; }.next-experiment span { color: var(--text-faint); font-size: 10px; }.next-experiment strong { margin-top: 2px; font-size: var(--fs-sm); }
.next-experiment a { display: inline-flex; align-items: center; gap: var(--sp-2); flex: 0 0 auto; padding: var(--sp-2) var(--sp-3); border-radius: var(--radius-sm); background: var(--accent); color: #fff; font-size: var(--fs-xs); font-weight: var(--fw-semibold); text-decoration: none; }
