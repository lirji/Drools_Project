...
.stat div { display: flex; align-items: baseline; justify-content: space-between; gap: var(--sp-2); }.stat small { color: var(--text-soft); font-size: 11px; }.stat strong { font-family: var(--mono); font-size: 22px; line-height: 1; }
...
.kicker { color: var(--accent); font-family: var(--mono); font-size: 9px; font-weight: var(--fw-bold); letter-spacing: .12em; }.workspace-head h2 { margin: 2px 0 0; font-size: var(--fs-lg); }.result-count { color: var(--text-faint); font-size: var(--fs-xs); }
