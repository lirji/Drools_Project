...
.form-section { padding: var(--sp-4); border-bottom: 1px solid var(--border); }.section-label { display: flex; align-items: center; justify-content: space-between; margin-bottom: var(--sp-3); }.section-label span { font-size: var(--fs-xs); font-weight: var(--fw-bold); letter-spacing: .06em; text-transform: uppercase; }.section-label small { color: var(--text-faint); font-size: var(--fs-2xs); }.field-grid { display: grid; grid-template-columns: 1fr 1fr; gap: var(--sp-3); }.field { display: flex; flex-direction: column; gap: var(--sp-1); min-width: 0; }.field.full + .field-grid, .field-grid + .field.full { margin-top: var(--sp-3); }.field > span { display: flex; justify-content: space-between; color: var(--text-soft); font-size: var(--fs-xs); font-weight: var(--fw-medium); }.field > span i { color: var(--text-faint); font-size: var(--fs-2xs); font-style: normal; font-weight: var(--fw-medium); }.input-wrap { display: flex; align-items: center; gap: var(--sp-2); min-height: 40px; padding: 0 var(--sp-3); border: 1px solid var(--border); border-radius: var(--radius-sm); background: var(--bg-soft); color: var(--text-faint); }.input-wrap:focus-within { border-color: var(--accent); background: var(--bg-elev); box-shadow: var(--focus-ring); }.input-wrap input { width: 100%; min-width: 0; border: 0; outline: 0; background: transparent; color: var(--text); font: inherit; font-size: var(--fs-sm); }.input-wrap b { color: var(--text-soft); font-size: var(--fs-sm); }.actions { display: flex; gap: var(--sp-2); justify-content: flex-end; padding: var(--sp-4); }.actions button { min-height: 42px; border-radius: var(--radius-sm); cursor: pointer; font: inherit; font-size: var(--fs-xs); }.actions button:disabled { cursor: wait; opacity: .6; }.clear { padding: 0 var(--sp-4); border: 1px solid var(--border); background: var(--bg-elev); color: var(--text-soft); }.run { display: inline-flex; align-items: center; justify-content: center; gap: var(--sp-2); min-width: 170px; padding: 0 var(--sp-4); border: 0; background: linear-gradient(100deg, var(--accent), var(--accent-2)); color: var(--text-invert); font-weight: var(--fw-semibold); box-shadow: 0 8px 18px color-mix(in srgb, var(--accent) 20%, transparent); }.gift-run { background: linear-gradient(100deg, var(--blue), var(--accent-2)); }.run.secondary { border: 1px solid var(--border); background: var(--bg-elev); color: var(--text-soft); box-shadow: none; }.spinning { animation: spin .9s linear infinite; }
