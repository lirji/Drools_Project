...
.hero-timeline { display: flex; align-items: center; gap: var(--sp-3); flex: 0 0 auto; }.hero-timeline span { display: flex; flex-direction: column; }.hero-timeline small { color: var(--text-faint); font-size: 9px; }.hero-timeline strong { margin-top: 2px; font-family: var(--mono); font-size: 10px; }.hero-timeline :deep(svg) { color: var(--text-faint); }
...
.benefit-card { display: flex; align-items: center; gap: var(--sp-4); padding: var(--sp-4); border: 1px solid var(--accent-line); border-radius: var(--radius-sm); background: var(--accent-soft); }.benefit-icon { display: inline-flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 12px; background: var(--bg-elev); color: var(--accent); }.benefit-card div { min-width: 0; }.benefit-card small, .benefit-card strong, .benefit-card span, .benefit-card code { display: block; }.benefit-card small { color: var(--text-faint); font-size: 9px; }.benefit-card strong { margin-top: 2px; font-size: var(--fs-sm); }.benefit-card .amount { color: var(--accent); font-family: var(--mono); font-size: 24px; }.benefit-card .amount i { font-family: var(--sans); font-size: 11px; font-style: normal; }.benefit-card span, .benefit-card code { overflow: hidden; margin-top: 3px; color: var(--text-soft); font-size: 10px; text-overflow: ellipsis; white-space: nowrap; }
.gift-list, .binding-list { display: flex; flex-direction: column; }.gift-row { display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: var(--sp-3); padding: var(--sp-2) 0; border-bottom: 1px solid var(--border); }.gift-row:last-child { border-bottom: 0; }.gift-index { display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; border-radius: 8px; background: var(--bg-soft); color: var(--text-faint); font-family: var(--mono); font-size: 10px; }.gift-row strong, .gift-row small { display: block; }.gift-row strong { font-size: var(--fs-xs); }.gift-row small { color: var(--text-faint); font-size: 9px; }.gift-row b { color: var(--text-soft); font-family: var(--mono); font-size: 10px; }
.card-note { display: flex; align-items: flex-start; gap: var(--sp-2); margin-bottom: var(--sp-3); color: var(--text-soft); font-size: 10px; line-height: 1.6; }.code-panel { overflow: hidden; border: 1px solid #292d3a; border-radius: var(--radius-sm); background: #11131a; }.code-head { display: flex; align-items: center; justify-content: space-between; padding: var(--sp-2) var(--sp-3); border-bottom: 1px solid #292d3a; background: #181b24; color: #9ca3b5; font-family: var(--mono); font-size: 9px; }.code-head span { display: inline-flex; align-items: center; gap: var(--sp-2); }.code-head i { width: 7px; height: 7px; border-radius: 50%; background: #4ade80; }.code-head small { font-size: 8px; }.code-panel pre { max-height: 360px; overflow: auto; margin: 0; padding: var(--sp-3); color: #d7dbea; font-family: var(--mono); font-size: 10px; line-height: 1.65; white-space: pre-wrap; word-break: break-word; }.code-panel.drl { margin-top: var(--sp-2); }.sub-label { margin-top: var(--sp-4); color: var(--text-soft); font-size: 10px; font-weight: var(--fw-semibold); }.pass-all { display: flex; align-items: center; gap: var(--sp-2); padding: var(--sp-3); border: 1px solid var(--border); border-radius: var(--radius-sm); background: var(--green-soft); color: var(--green); }.pass-all strong, .pass-all small { display: block; }.pass-all strong { font-size: var(--fs-xs); }.pass-all small { font-size: 9px; }
